...
-  **dedicated physical connection** between your `on-premises data center` and `AWS`
- Bypasses the public internet, offering a private, high-bandwidth, low-latency link
```
