...
---
## B AWS::VPC <==INTERNET==> client::VPN (on client dataCenter)
### B.1. AWS Site-2-site VPN ::  `AWS::VPC-1` to `Client-VPN-1`
```
...
---
## C AWS::VPC <==NO-INTERNET==> client::VPN (on client dataCenter)
